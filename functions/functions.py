...
def add_to_startup_windows(file_path=""):
    ...
    with open(bat_path + '\\' + "monitoramento.bat", "w+") as bat_file:
        bat_file.write(f'@echo off\nstart {file_path}')

def remove_to_startup_windows():
    bat_path = f'C:\\Users\\{USER_NAME}\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Startup\\monitoramento.bat'
    os.remove(bat_path)
